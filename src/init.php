 ...
 * @since 1.0.0
 */
function gutenberg_card_block_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'gutenberg_card_block-cgb-style-css', // Handle.
	...
	wp_register_script(
		'gutenberg_card_block-cgb-block-js', // Handle.
	...
	wp_register_style(
		'gutenberg_card_block-cgb-block-editor-css', // Handle.
